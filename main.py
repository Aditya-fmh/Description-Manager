...
descriptions = {
    'Lenovo': {
        ...
        'T420': ['#JUAL\n#WTS\nKontak: 088221957963\n\nLaptop Lenovo T420 seken bergaransi mulus no minus\n\nSpesifikasi:\nIntel Core i5 Gen 2\nRAM 4 GB\nHDD 320 GB\n\nLaptop fullset, aplikasi lengkap siap pakai.', 'Description 2 for Lenovo Type 2', 'Description 3 for Lenovo Type 2'],
